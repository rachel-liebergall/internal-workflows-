...
**To post to a channel:** POST to `https://slack.com/api/chat.postMessage` with body `{"channel": "C0BAJHSBHHB", "text": "YOUR MESSAGE", "mrkdwn": true}` and header `Authorization: Bearer $BAXTER_TOKEN`.
